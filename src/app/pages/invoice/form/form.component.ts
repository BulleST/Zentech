...
export class FormComponent implements OnDestroy {
  ...
  async beneficiarioChange() {
    if (this.objeto.invoice.beneficiario_Id) {
      ...
      console.log(this.beneficiarioSelected?.cep)

      // if (this.beneficiarioSelected != undefined ) {
      //     this.beneficiarioSelected.cep = this.mask.applyMask(this.beneficiarioSelected.cep.toString(), '00000-000');
      // }
